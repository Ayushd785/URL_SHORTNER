...
import { Link, Eye, EyeOff, Check, AlertCircle } from "lucide-react";
...
export default function Signup() {
  ...
  // Get the intended destination after signup
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description: "Welcome to LinklyPro. You're now signed in.",
        });
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Create a new account to get started with LinklyPro
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* Error Alert */}
